...
def load_c3d_env(path, dset_name="anet"):
    ...
    if dset_name == "anet":
        feature = np.array([d["features"] for d in feat_dict["video_features"]]) # anet
    elif dset_name == "yc2":
...
class RecursiveCaptionDataset(Dataset):
    ...
    data_path = {
        "anet": {
            "env_feat": "/scratch/cchuan24/VLTinT/data/anet/c3d_env",
            "agent_feat": "/scratch/cchuan24/VLTinT/data/anet/c3d_agent",
            "clip_feat": "/scratch/cchuan24/VLTinT/data/anet/clip_b16/lang_feature/lang_feature/",
            "sent_feat": "/scratch/cchuan24/VLTinT/data/anet/clip_b16/sent_feature/"
        },
        "yc2": {
            "env_feat": "/scratch/cchuan24/VLTinT/data/yc2/c3d_env",
            "agent_feat": "/scratch/cchuan24/VLTinT/data/yc2/c3d_agent",
            "clip_feat": "/scratch/cchuan24/VLTinT/data/yc2/clip_b16/lang_feature/lang_feature/",
            "sent_feat": "/scratch/cchuan24/VLTinT/data/yc2/clip_b16/sent_feature/"
        }
    }
